    ...
    public void onEnable() {
        ...
        if (!yml.exists()) {
            ...
            try {
                ...
                out.newLine();
                out.write("use-permissions: 'permissions'  #permissions, OP, bukkitPerms or false");
                out.newLine();
                out.write("transaction-fee: 0.0    #Fee for sending something");
                out.newLine();
                out.write("allow-cross-world-sending: true      #Whether people should be able to send stuff to someone in another world. set allow-offline to false to enforce");
        ...
        crossWorld = getConfiguration().getBoolean("allow-cross-world-sending", true);
